  ...
  return (
    ...
    <div className='w-[350px] text-[#FFFFFF] p-2'>
        <div className='bg-[#561381] p-4 rounded-md'>
            <h2 className='text-xl mb-3'>Welcome to Second Gear</h2>
            <p className='text-sm mb-3'>Please register to your account and start your bussiness</p>
            <form onSubmit={submit}>
                <div className='flex flex-col w-full gap-1 mb-3'>
                    <label htmlFor="name">Name</label>
                    <input onChange={inputHandle} value={state.name} className='px-3 py-2 outline-none border border-violet-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-violet-400 overflow-hidden' type="text" name='name' placeholder='name' id='name' required />
                </div>
                <div className='flex flex-col w-full gap-1 mb-3'>
                    <label htmlFor="email">Email</label>
                    <input onChange={inputHandle} value={state.email} className='px-3 py-2 outline-none border border-violet-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-violet-400 overflow-hidden' type="email" name='email' placeholder='email' id='email' required />
                </div>
                <div className='flex flex-col w-full gap-1 mb-3'>
